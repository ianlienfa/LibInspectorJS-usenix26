...
(function (sandbox) {
    ...
    function MyAnalysis() {
        ...
        this.invokeFunPre = function (iid, f, base, args, isConstructor, isMethod, functionIid, functionSid) {
            ...
            ret += ") of function created at "+jalangiinstrumentation.iidToLocation(functionSid, functionIid);
            ret += " at " + jalangiinstrumentation.iidToLocation(jalangiinstrumentation.sid, iid);
            log(ret);
            indentationCount++;
