...
(function (sandbox) {
    ...
    function MyAnalysis() {
        ...
        function getBranchInfo() {
            var branchInfo = branches[jalangiinstrumentation.sid - 1];
            if (!branchInfo) {
                var iids = jalangiinstrumentation.smap[jalangiinstrumentation.sid];
                var fileName = iids.originalCodeFileName;
                branchInfo = {};
                branches[jalangiinstrumentation.sid - 1] = branchInfo;
                branchSidToFileName[jalangiinstrumentation.sid - 1] = fileName;
            }
            return branchInfo;
        }
