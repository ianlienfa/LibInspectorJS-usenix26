...
(function (sandbox) {
    function MyAnalysis() {
        ...
        this.getField = function (iid, base, offset, val, isComputed, isOpAssign, isMethodCall) {
            ...
            console.log("getField("+JSON.stringify(args)+") at " + jalangiinstrumentation.iidToLocation(jalangiinstrumentation.sid, iid));
            return {result: val};
        };
        ...
        this.putField = function (iid, base, offset, val, isComputed, isOpAssign) {
            ...
            console.log("putField("+JSON.stringify(args)+") at " + jalangiinstrumentation.iidToLocation(jalangiinstrumentation.sid, iid));
            return {result: val};
        };
