(function (sandbox) {
    function MyAnalysis() {
        ...
        this.getFieldPre = function (iid, base, offset, isComputed, isOpAssign, isMethodCall) {
            ...
            console.log("GET_FIELD "+sandbox.smemory.getIDFromShadowObjectOrFrame(shadowObj.owner)+"." + offset +" at " + jalangiinstrumentation.iidToLocation(jalangiinstrumentation.sid, iid));
        };
        ...
        this.read = function (iid, name, val, isGlobal, isScriptLocal) {
            ...
            console.log("READ "+sandbox.smemory.getIDFromShadowObjectOrFrame(shadowObj)+"." + name +" at " + jalangiinstrumentation.iidToLocation(jalangiinstrumentation.sid, iid));
        };

        this.write = function (iid, name, val, lhs, isGlobal, isScriptLocal) {
            var shadowObj = sandbox.smemory.getShadowFrame(name);
            console.log("WRITE "+sandbox.smemory.getIDFromShadowObjectOrFrame(shadowObj)+"." + name +" at " + jalangiinstrumentation.iidToLocation(jalangiinstrumentation.sid, iid));
        };
