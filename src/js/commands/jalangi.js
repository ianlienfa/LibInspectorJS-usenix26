...
jalangiinstrumentation.initParams = initParam || {};
if (args.analysis) {
...
Module._extensions['.js'] = function (module, filename) {
    ...
    var instCodeAndData = jalangiinstrumentation.instrumentCode(
        {
            code: code,
            isEval: false,
    ...
    instUtil.applyASTHandler(instCodeAndData, astHandler, jalangiinstrumentation);
...
function startProgram() {
    ...
    process.on('exit', function () { jalangiinstrumentation.endExecution(); });
    Module.Module.runMain(script, null, true);
}

if (jalangiinstrumentation.analysis && jalangiinstrumentation.analysis.onReady) {
    jalangiinstrumentation.analysis.onReady(startProgram);
} else {
    startProgram();
}
