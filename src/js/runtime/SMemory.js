...
(function (sandbox) {
     ...
     * smemory can be accessed via jalangiinstrumentation.smemory or sandbox.smemory.  The smemory object defines several methods.
    ...
    function SMemory() {
         ...
         * call jalangiinstrumentation.smemory.getFrame("this");
         *
         * @param name - Name of the variable whose owner activation frame's shadow object we want to retrieve
         * @returns {Object} -  The shadow object of the activation frame owning the variable.
         */
