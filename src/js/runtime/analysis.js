...
// create / reset jalangiinstrumentation global variable to hold analysis runtime
...
(function (sandbox) {
    ...
    function callBinary(op, left, right, iid) {
        switch (op) {
            case "+":
                return left + right;
            case "-":
    ...
    function callUnary(op, left, iid) {
        switch (op) {
            case "+":
                return +left;
            case "-":
    ...
    function B(iid, op, left, right, flags) {
        ...
        if (!skip) {
            result = callBinary(op, left, right, iid);
        }
    ...
    sandbox.util = {};
    sandbox.util.callFun = callFun;
    sandbox.util.callBinary = callBinary;
    sandbox.util.callUnary = callUnary;
})(jalangiinstrumentation);
