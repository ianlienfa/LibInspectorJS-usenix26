...
if __name__ == '__main__':
    ...
    print(f"Website is hold on 127.0.0.1:{PORT}")
    print(f"Try to visit: http://127.0.0.1:{PORT}/test/jquery/1")
    print(f"If you want to load dependecies, try this: http://127.0.0.1:{PORT}/test/jquery/1?dep1=jquery/3.7.1/jquery.min.js&dep2=underscore.js/1.13.6/underscore-min.js")
