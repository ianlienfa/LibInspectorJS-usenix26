...
In total, there are 584 libraries collected by the tool. Among them, 425 are equipped with fine-grained version features.

Data update time: 14.Sep 2024 08:53:04

| Library | GitHub Star | Version Detection? | # Versions | Description |
| ------- | ----------- | -------- | ---------- | ----------- |
| [react](https://facebook.github.io/react/) | 227.3 k | N | 934 | React is a JavaScript library for building user interfaces. |
| [vue](http://vuejs.org) | 207.7 k | N | 524 | Simple, Fast & Composable MVVM for building interactive interfaces |
| [vue](http://vuejs.org) | 207.7 k | N | 524 | Simple, Fast & Composable MVVM for building interactive interfaces |
| [bootstrap](http://getbootstrap.com/) | 170.0 k | Y | 28 | The most popular front-end framework for developing responsive, mobile first projects on the web. |
| [d3](https://d3js.org) | 108.4 k | Y | 263 | A JavaScript visualization library for HTML and SVG. |
| axios | 105.2 k | Y | 100 | Promise based HTTP client for the browser and node.js |
| [three.js](http://threejs.org/) | 101.7 k | Y | 263 | JavaScript 3D library |
| [angular](https://github.com/angular/angular#readme) | 95.7 k | N | 476 | Angular - the core framework |
| [font-awesome](https://fontawesome.com/) | 73.5 k | Y | 101 | The iconic SVG, font, and CSS toolkit |
| [reveal.js](https://revealjs.com/) | 67.6 k | Y | 56 | The HTML Presentation Framework |
| [Chart.js](http://www.chartjs.org) | 64.3 k | Y | 110 | Simple HTML5 charts using the canvas element. |
| [socket.io](https://socket.io) | 60.9 k | Y | 129 | node.js realtime framework server |
| [redux](http://redux.js.org) | 60.8 k | Y | 61 | Predictable state container for JavaScript apps |
| [echarts](https://echarts.apache.org) | 60.1 k | Y | 117 | A powerful, interactive charting and data visualization library for browser |
| [lodash.js](http://lodash.com/) | 59.6 k | Y | 112 | A utility library delivering consistency, customization, performance, & extras. |
| [jquery](http://jquery.com/) | 59.1 k | Y | 84 | JavaScript library for DOM operations |
| [angular-loader](http://angularjs.org) | 58.9 k | N | 14 | Module loader for AngularJS modules. If you are loading multiple script files containing AngularJS modules, you can load them asynchronously and in any order as long as you load this file first. |
| [element-ui](http://element.eleme.io) | 54.1 k | Y | 164 | A Component Library for Vue.js. |
| [semantic-ui](http://semantic-ui.com/) | 51.1 k | Y | 160 | Semantic empowers designers and developers by creating a shared vocabulary for UI. |
| [animejs](http://anime-js.com) | 49.6 k | Y | 14 | Polyvalent Javascript animation engine |
| prettier | 49.1 k | Y | 69 | Prettier is an opinionated code formatter |
| [kotlin](http://kotlinlang.org) | 48.8 k | Y | 86 | Standard Library for Kotlin Applications |
| [moment.js](http://momentjs.com/) | 47.9 k | Y | 78 | Parse, validate, manipulate, and display dates |
| dayjs | 46.6 k | N | 119 | 2KB immutable date library alternative to Moment.js with the same modern API  |
| [admin-lte](http://almsaeedstudio.com) | 43.9 k | N | 54 | Admin dashboard and control panel template |
| [pixi.js](http://goodboydigital.com/) | 43.6 k | Y | 379 | Pixi.js is a fast lightweight 2D library that works across all devices. |
| [6to5](https://6to5.org/) | 43.1 k | Y | 190 | Turn ES6 code into readable vanilla ES5 with source maps |
| [babel-core](https://babeljs.io/) | 43.1 k | Y | 184 | A compiler for writing next generation JavaScript |
| babel-standalone | 43.1 k | Y | 142 | Standalone build of Babel for use in non-Node.js environments. Similar to the (now deprecacted) babel-browser |
| [quill](http://quilljs.com) | 43.1 k | Y | 103 | Cross browser rich text editor |
| [leaflet](http://leafletjs.com/) | 41.0 k | Y | 52 | JavaScript library for mobile-friendly interactive maps |
| [materialize](http://materializecss.com/) | 38.9 k | Y | 44 | Builds Materialize distribution packages |
| impress.js | 37.6 k | N |  | It's a presentation framework based on the power of CSS3 transforms and transitions in modern browsers and inspired by the idea behind prezi.com |
...
| [modernizr](http://www.modernizr.com/) | 25.6 k | Y | 34 | Modernizr is a JavaScript library that detects HTML5 and CSS3 features in the user’s browser. |
...
| [trix](http://trix-editor.org/) | 19.0 k | Y | 52 | A rich text editor for everyday writing |
...
| [pace](https://codebyzach.github.io/pace/) | 15.7 k | Y | 46 | Automatically add a progress bar to your site. |
...
| [peerjs](http://peerjs.com/) | 12.3 k | Y | 57 | PeerJS client |
...
| [acorn-walk](https://github.com/acornjs/acorn) | 10.5 k | Y | 20 | ECMAScript (ESTree) AST walker |
...
| [flowchart](http://flowchart.js.org/) | 8.5 k | N | 53 | Draws simple SVG flow chart diagrams from textual representation of the diagram |
...
| [json5](http://json5.org) | 6.5 k | N | 28 | JSON for the ES5 era. |
...
| [html5-qrcode](https://github.com/mebjas/html5-qrcode#readme) | 4.9 k | Y | 53 | a cross platform HTML5 QR Code scanner |
...
| plottable.js | 3.0 k | Y | 191 | A modular charting library built on D3 |
