! function() {
  var e = 736 < $(window).width();
  var i = (new Swiper(".large .swiper-container", {
    effect: e ? "fade" : "slide",
    loop: !e,
    autoplay: !e && {
      delay: 5e3
    ...
    thumbs: e && document.querySelectorAll(".thumb .swiper-container").length ? {
      swiper: {
    ...
    on: {
      click: e ? function() {
        var e = this.clickedIndex;
        var i = tp.showDialog($(".large-gallery").html(), {
          className: "large-gallery"
        });
        i.find(".large-gallery-index").text(e + 1);
        new Swiper(".tp-dialog.large-gallery .swiper-container", {
          loop: !0,
          initialSlide: e,
          lazy: !0,
          navigation: {
  ...
  var t = $(".product-info-basic .brief");
  var n = i.find(".gallery-inner");
  var o = i.width();
  var e = ($(window).on("resize", function() {
    o = i.width();
  }), $(window).on("scroll resize", function() {
    736 < $(window).width() && t.height() > n.height() && i[0].getBoundingClientRect().top < 0 ? (i.css({
      height: t.height()
    }), t[0].getBoundingClientRect().bottom < n.height() ? n.css({
      position: "absolute",
      top: "auto",
      bottom: 0,
      width: o
  ...
  var l = e.find(".tp-btn");
  var a = l.clone();
  l.length && a.appendTo($("<li class='col buy" + (e.hasClass("hidden") ? " hidden" : "") + "'></li>").appendTo($(".product-menu-list"))).on("click", function() {
    $(this).attr("href") || l.trigger("click");
  });
  e.on("click", ".default-button", function() {
    var e = $(".buy-now-dialog-tpl1");
...
$(function() {
  ...
  0 != e.length && e.each(function(e, i) {
    ...
    var l;
    var a = $(this);
    var r = a.children("div.hover").children("div.wrapper");
    0 != r.length && (t = $("<tbody/>"), r.find("li").each(function(e, i) {
      $("<tr/>").append($("<td/>").append($(this).children("img").remove())).append($("<td/>").append($(this).html())).appendTo(t);
    }), l = tpWeb.browser.msie, l = !!(l && l.version && l.version < 8), n = $("<dl/>"), o = this, l && n.width(o.clientWidth - 76), n.append($("<dt/>").append(((l = a.children("a").clone()).children("i").add(l.children("br:first")).remove(), l))).append($("<dd/>").append($("<table/>").append(t))).appendTo(r.html("")), a.hover(function() {
      $(this).click(function() {
