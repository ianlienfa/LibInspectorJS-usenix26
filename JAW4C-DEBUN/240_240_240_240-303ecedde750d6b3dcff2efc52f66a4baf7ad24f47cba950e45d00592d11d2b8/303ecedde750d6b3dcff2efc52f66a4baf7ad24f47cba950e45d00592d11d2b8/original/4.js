...
$(function () {
  ...
  $(function () {
    ...
    $(".swiper-section-1 .menu li").on("click", function () {
      var index = $(this).index();
      $(this).addClass("active").siblings().removeClass("active");
      $(".swiper-section-1 .c0").hide().eq(index).show();
    })
    if (window.innerWidth > 736) {
      var mySwiper = new Swiper('.swiper-section .swiper', {
        loop: true,
        pagination: {
          el: '.swiper-section .swiper-pagination',
        },
        navigation: {
          prevEl: ".swiper-section .tp-banner-prev .tp-banner-icon",
          nextEl: ".swiper-section .tp-banner-next .tp-banner-icon",
        },
        slidesPerView: "auto",
        // spaceBetween: 20,
        centeredSlides: true,
        ...
        on: {
          slideChangeTransitionEnd: function () {
            $(".swiper-section .menu li").siblings().removeClass("active");
            $(".swiper-section .menu li").eq(this.realIndex).addClass('active')
          }
        },
      })
    } else {
    ...
    $(".swiper-section .menu li").on("click", function () {
      var index = $(this).index();
      $(this).addClass("active").siblings().removeClass("active");
      mySwiper.slideToLoop(index % 3)
    })
...
$(function () {
  if ($(window).width() > 736) {
    var mySwiper = new Swiper('.d .swiper-1', {
      speed: 500,

      slidesPerView: 4,
      navigation: {
        prevEl: '.d .swiper-1 .prev',
        nextEl: '.d .swiper-1 .next'
      }

    });
    var mySwiper = new Swiper('.d .swiper-2', {
      speed: 500,

      slidesPerView: 4,
      navigation: {
        prevEl: '.d .swiper-2 .prev',
        nextEl: '.d .swiper-2 .next'
      }
...
$(function () {
  tp.playVideo($(".video-for-product .video"));
  var swiper = new Swiper('.video-for-product .swiper', {
    slidesPerView: "auto",
    spaceBetween: 14,

    navigation: {
      nextEl: '.video-for-product .next-icon',
      prevEl: '.video-for-product .prev-icon',
    },
