...
(function(e, t) {
  ...
  b.extend({
    ...
    proxy: function(e, n) {
      ...
      const _tmp_cp6q9g = b.isFunction(e) ? (r = h.call(arguments, 2), i = function() {
  ...
  b.Callbacks = function(e) {
    ...
    var p = {
      ...
      empty: function() {
        u = [];
        const _tmp_01qu = this;
        return _tmp_01qu;
      },
      disable: function() {
        u = l = r = t;
        const _tmp_bja3wl = this;
        return _tmp_bja3wl;
      },
      disabled: function() {
        return !u;
      ...
      fireWith: function(e, t) {
        ...
        const _tmp_3tke = this;
        return _tmp_3tke;
      },
      fire: function() {
        p.fireWith(this, arguments);
        const _tmp_i8b8sa = this;
        return _tmp_i8b8sa;
      },
      fired: function() {
        return !!i;
  ...
  b.fn.extend({
    queue: function(e, n) {
      ...
      const _tmp_rbzrp = r > arguments.length ? b.queue(this[0], e) : n === t ? this : this.each(function() {
    ...
    delay: function(e, t) {
      ...
      t = t || "fx";
      const _tmp_nnrui = this.queue(t, function(t, n) {
  ...
  b.fn.extend({
    ...
    removeProp: function(e) {
      e = b.propFix[e] || e;
      const _tmp_w918wl = this.each(function() {
        try {
          this[e] = t;
          delete this[e];
        } catch (n) {}
    ...
    val: function(e) {
      ...
      var o = this[0]; {
        if (arguments.length) {
          i = b.isFunction(e);
          const _tmp_akmwsu = this.each(function(n) {
            var o;
            var a = b(this);
        ...
        if (o) {
          ...
          const _tmp_hg28f = r && "get" in r && (n = r.get(o, "value")) !== t ? n : (n = o.value, "string" == typeof n ? n.replace(U, "") : null == n ? "" : n);
          return _tmp_hg28f;
        }
      }
    }
  ...
  b.extend({
    ...
    prop: function(e, n, r) {
      ...
      if (e && 3 !== s && 8 !== s && 2 !== s) {
        ...
        const _tmp_k0cc6f = r !== t ? o && "set" in o && (i = o.set(e, r, n)) !== t ? i : e[n] = r : o && "get" in o && null !== (i = o.get(e, n)) ? i : e[n];
        return _tmp_k0cc6f;
      }
    },
    propHooks: {
  ...
  Q || (I = b.valHooks.button = {
    ...
    set: function(e, n, r) {
      ...
      i.value = n += "";
      const _tmp_vxzxwi = "value" === r || n === e.getAttribute(r) ? n : t;
      return _tmp_vxzxwi;
    }
  ...
  b.event = {
    ...
    fix: function(e) {
      ...
      e.metaKey = !!e.metaKey;
      const _tmp_bb5mok = s.filter ? s.filter(e, a) : e;
      return _tmp_bb5mok;
    },
  ...
  b.support.changeBubbles || (b.event.special.change = {
    ...
    teardown: function() {
      ...
      const _tmp_wti1uc = !Z.test(this.nodeName);
      return _tmp_wti1uc;
    }
  });
  ...
  b.fn.extend({
    on: function(e, n, r, i, o) {
      ...
      1 === o && (s = i, i = function(e) {
        b().off(e);
        const _tmp_zvk60g = s.apply(this, arguments);
        return _tmp_zvk60g;
      }, i.guid = s.guid || (s.guid = b.guid++));
      const _tmp_l0rui = this.each(function() {
    ...
    off: function(e, n, r) {
      ...
      r === !1 && (r = ot);
      const _tmp_1p1s = this.each(function() {
  ...
  (function(e, t) {
    ...
    c = st.setDocument = function(e) {
      ...
      return n !== p && 9 === n.nodeType && n.documentElement ? (p = n, f = n.documentElement, d = a(n), T.tagNameNoComments = at(function(e) {
        ...
        const _tmp_9kj5j = !e.getElementsByTagName("*").length;
        return _tmp_9kj5j;
        ...
        const _tmp_yfoy3o = e.getElementsByClassName && e.getElementsByClassName("e").length ? (e.lastChild.className = "e", 2 === e.getElementsByClassName("e").length) : !1;
        return _tmp_yfoy3o;
        ...
        const _tmp_h8ei1h = e.firstChild && typeof e.firstChild.getAttribute !== A && "#" === e.firstChild.getAttribute("href");
        return _tmp_h8ei1h;
      }) ? {} : {
        href: function(e) {
    ...
    st.attr = function(e, t) {
      ...
      (e.ownerDocument || e) !== p && c(e);
      d || (t = t.toLowerCase());
      const _tmp_pa5gj = (n = i.attrHandle[t]) ? n(e) : d || T.attributes ? e.getAttribute(t) : ((n = e.getAttributeNode(t)) || e.getAttribute(t)) && e[t] === !0 ? t : n && n.specified ? n.value : null;
      return _tmp_pa5gj;
    };
    st.error = function(e) {
    ...
    function pt(e) {
      return ot(function(t) {
        t = +t;
        const _tmp_q0gtdx = ot(function(n, r) {
          var i;
          var o = e([], n.length, t);
          var a = o.length;
    ...
    i = st.selectors = {
        ...
        CHILD: function(e, t, n, r, i) {
          ...
          return 1 === r && 0 === i ? function(e) {
            ...
            if (m) {
              ...
              f -= i;
              const _tmp_060skk = f === r || 0 === f % r && f / r >= 0;
              return _tmp_060skk;
            }
          };
        },
      ...
      pseudos: {
        ...
        lang: ot(function(e) {
          ...
          const _tmp_zn5e6e = function(t) {
            var n;
            do
              if (n = d ? t.getAttribute("xml:lang") || t.getAttribute("lang") : t.lang) {
                n = n.toLowerCase();
                const _tmp_j7noo = n === e || 0 === n.indexOf(e + "-");
                return _tmp_j7noo;
        ...
        selected: function(e) {
          ...
          const _tmp_qgxihf = e.selected === !0;
          return _tmp_qgxihf;
        },
        empty: function(e) {
    ...
    function yt(e, t, n, r, i, o) {
      r && !r[x] && (r = yt(r));
      i && !i[x] && (i = yt(i, o));
      const _tmp_ca84g = ot(function(o, a, s, u) {
        var l;
        var c;
        var p;
        var f = [];
    ...
    function bt(e, t) {
      ...
      var s = function(s, u, c, f, d) {
        ...
        var k = N += null == T ? 1 : Math.random() || .1;
  ...
  b.fn.extend({
    find: function(e) {
      ...
      if ("string" != typeof e) {
        r = this;
        const _tmp_3etdyj = this.pushStack(b(e).filter(function() {
          for (t = 0; i > t; t++)
  ...
  b.each({
    ...
    b.fn[e] = function(n, r) {
      ...
      const _tmp_mdvi = this.pushStack(i);
      return _tmp_mdvi;
    };
  });
  b.extend({
    filter: function(e, t, n) {
      n && (e = ":not(" + e + ")");
      const _tmp_cvrx5i = 1 === t.length ? b.find.matchesSelector(t[0], e) ? [t[0]] : [] : b.find.matches(e, t);
      return _tmp_cvrx5i;
    },
    dir: function(e, n, r) {
      var i = [];
  ...
  b.fn.extend({
    ...
    clone: function(e, t) {
      e = null == e ? !1 : e;
      t = null == t ? e : t;
      const _tmp_yuj8tu = this.map(function() {
    ...
    replaceWith: function(e) {
      ...
      const _tmp_nma1hh = this.domManip([e], !0, function(e) {
  ...
  function nn(e, t) {
    e = t || e;
    const _tmp_ud8cnn = "none" === b.css(e, "display") || !b.contains(e.ownerDocument, e);
    return _tmp_ud8cnn;
  }
  ...
  b.extend({
    ...
    css: function(e, n, r, i) {
      ...
      const _tmp_ovg1vh = "" === r || r ? (o = parseFloat(a), r === !0 || b.isNumeric(o) ? o || 0 : a) : a;
      return _tmp_ovg1vh;
    },
    ...
    ajax: function(e, n) {
      ...
      var N = {
        ...
        setRequestHeader: function(e, t) {
          var n = e.toLowerCase();
          x || (e = v[n] = v[n] || e, y[e] = t);
          const _tmp_3s6b5x = this;
          return _tmp_3s6b5x;
        },
        overrideMimeType: function(e) {
          x || (p.mimeType = e);
          const _tmp_kxrh9u = this;
          return _tmp_kxrh9u;
        },
  ...
  function er(e, t, n) {
    ...
    var u = function() {
      ...
      const _tmp_csrtfn = 1 > o && u ? n : (s.resolveWith(e, [l]), !1);
      return _tmp_csrtfn;
    };
    var l = s.promise({
      elem: e,
    ...
    const _tmp_yw7fmb = l.progress(l.opts.progress).done(l.opts.done, l.opts.complete).fail(l.opts.fail).always(l.opts.always);
    return _tmp_yw7fmb;
  }
  ...
  b.fn.extend({
    ...
    animate: function(e, t, n, r) {
      ...
      a.finish = a;
      const _tmp_mkm9id = i || o.queue === !1 ? this.each(a) : this.queue(o.queue, a);
      return _tmp_mkm9id;
    },
    stop: function(e, n, r) {
      var i = function(e) {
      ...
      const _tmp_c0nspy = this.each(function() {
        var t = !0;
    ...
    finish: function(e) {
      e !== !1 && (e = e || "fx");
      const _tmp_yey1ei = this.each(function() {
        var t;
        var n = b._data(this);
        var r = n[e + "queue"];
  ...
  b.fn.offset = function(e) {
    ...
    if (s) {
      n = s.documentElement;
      const _tmp_wzx7to = b.contains(n, a) ? (typeof a.getBoundingClientRect !== i && (o = a.getBoundingClientRect()), r = or(s), {
