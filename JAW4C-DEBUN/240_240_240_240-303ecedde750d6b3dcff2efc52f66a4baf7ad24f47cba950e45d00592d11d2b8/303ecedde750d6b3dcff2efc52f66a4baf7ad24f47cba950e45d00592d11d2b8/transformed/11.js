...
typeof tp != 'undefined' && tp.fixedView.add({
  ...
  excludeUrls: [/\/business-networking\/consult\//, /\/smb\/select-product\//, /\/us\/omada-sdn\/$/],
  checkShowHandler: function() {
