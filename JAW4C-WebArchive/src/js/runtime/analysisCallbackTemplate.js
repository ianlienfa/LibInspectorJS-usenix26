...
(function (sandbox) {
     ...
     *     using the global object stored in <code>jalangiinstrumentation.smap</code>.  Jalangi 2
     *     assigns a unique id, called <code>sid</code>, to each JavaScript
     *     script loaded at runtime.  <code>jalangiinstrumentation.smap</code> maps each <code>sid</code> to an object, say
     ...
     *     the current script id using <code>jalangiinstrumentation.sid</code>.  One can call <code>jalangiinstrumentation.getGlobalIID(iid)</code> to get a string, called
     *     <code>giid</code>, that statically identifies the
     *     callback throughout the program.  <code>jalangiinstrumentation.getGlobalIID(iid)</code> returns the string <code>jalangiinstrumentation.sid+":"+iid</code>.
     *     <code>jalangiinstrumentation.iidToLocation(giid)</code> returns a string
    ...
    function MyAnalysis() {
        ...
        /**
         * This callback is called only when instrumented with jalangiinstrumentation.Config.ENABLE_SAMPLING = true
